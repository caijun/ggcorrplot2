...
To cite the ‘ggcorrplot2’ package in publications use:
      ...
      Jun Cai and Granville Matheson (2021). ggcorrplot2: Visualize a Correlation Matrix using ggplot2. R package version 0.1.1.

A BibTeX entry for LaTeX users is

      @Manual{,
        title = {ggcorrplot2: Visualize a Correlation Matrix using ggplot2},
        author = {Jun Cai and Granville Matheson},
        year = {2021},
